...
class Asset(models.Model):
    ...
    asset_market = models.CharField(max_length=20)
    ...
    volume_weighted_price = models.FloatField(validators=[MinValueValidator(0)], blank=True, null=True)
    volume = models.FloatField(validators=[MinValueValidator(0)], blank=True, null=True)
    transactions = models.IntegerField(validators=[MinValueValidator(0)], blank=True, null=True)
...
class AssetHistory(TimescaleModel):
    ...
    transactions = models.IntegerField(validators=[MinValueValidator(0)])
